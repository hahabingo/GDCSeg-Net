...
import os
import random
from model.GDCSegNet import GDCSegNet
import torch
...
def main(mode='train',args=None,writer=None,k_fold=1):
    ...
    dataset_train = PiFu(dataset_path, scale=(args.crop_height, args.crop_width),k_fold_test=k_fold,mode='train')
    ...
    dataset_val = PiFu(dataset_path, scale=(args.crop_height, args.crop_width),k_fold_test=k_fold,mode='val')
    ...
    dataset_test = PiFu(dataset_path, scale=(args.crop_height, args.crop_width),k_fold_test=k_fold,mode='test')
    ...
    model_all = {
                 'GDCSegNet': GDCSegNet(num_classes=args.num_classes, num_channels=args.input_channel),
                 }    
...
if __name__ == '__main__':
    ...
    if modes == 'train':
        ...
        log_dir = os.path.join(args.log_dirs, comments + '_' + current_time + '_' + socket.gethostname()+'_'+args.net_work)
